...
SG_ID="sg-0c4434e3941ebbcca" # replace with your SG ID
INSTANCES=("mongodb" "redis" "mysql" "rabbitmq" "catalogue" "user" "cart" "shipping" "payment" "dispatch" "frontend")
ZONE_ID="Z09248402W8JYCL29MVAP" # replace with your ZONE ID
DOMAIN_NAME="daws-84s.store" # replace with your domain
